...
A [map editor for *Warcraft II*](https://jcfields.gitlab.io/warcraft2-map-editor/) written in JavaScript. Currently can only view maps but not edit or save them.
